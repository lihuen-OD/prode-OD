...
export function mapMatch(apiMatch: any): Match {
  ...
  return {
    ...
    homeTeam: apiMatch.homeTeam?.name ?? apiMatch.homePlaceholder ?? 'Local por definir',
    awayTeam: apiMatch.awayTeam?.name ?? apiMatch.awayPlaceholder ?? 'Visitante por definir',
